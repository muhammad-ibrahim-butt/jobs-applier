...
def init() -> None:
    ...
    copies = [
        ...
        (Path("profile.example.yaml"), Path("profile.yaml")),
    ]
    ...
    console.print("1. Edit .env with your APIFY_API_TOKEN and SMTP settings")
    ...
    console.print("5. Run: [cyan]jobs-applier run --dry-run[/cyan]")
